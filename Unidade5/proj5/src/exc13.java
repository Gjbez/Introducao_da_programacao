...
public class exc13 {
  public exc13() {
     ...
     * viagem e imediatamente após retornar,
     * o motorista encheu o tanque do veículo e registrou as medidas do odômetro. Em
     * cada parada feita durante a viagem,
     * foi registrado o valor do odômetro e a quantidade de combustível comprado
     * para reabastecer o veículo
     * (suponha que o tanque foi enchido a cada parada). Descreva um algoritmo que
     * leia o número total de reabastecimentos
     * feitos e os dados registrados relativos à compra de combustível. Calcule e
     * escreva:
     * 
